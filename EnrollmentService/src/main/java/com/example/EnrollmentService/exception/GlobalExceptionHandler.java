...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EnrollmentProcessingException.class)
    public ResponseEntity<ErrorResponse> handleEnrollmentProcessingException(EnrollmentProcessingException ex, HttpServletRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
