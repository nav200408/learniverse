package com.example.UserService.jwt.config;

import com.example.UserService.jwt.security.JwtAuthenticationFilter;
                ...
                .exceptionHandling(ex -> ex
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            sendErrorResponse(response, 403, "Forbidden",
                                    "You do not have valid role to enter this endpoint");
                        }));
